...
public class FuncionsIArrays1 {
    ...
    void inici() {
         ...
         */
        int varEnter = 5;
        System.out.print("Abans de cridar a la funció canviarValorParametreInt(varEnter)");
        System.out.print("la variable varEnter val: ");
        System.out.println(varEnter);
        canviarValorParametreInt(varEnter);
        System.out.print("Després de cridar a la funció canviarValorParametreInt(varEnter)");
        System.out.print("la variable varEnter val: ");
        System.out.println(varEnter);
    }
