...
//Un programa que dóna diferents opcions de cálcul, usant la sentència switch.
public class Opcions {
    public static void main(String[] args) {
        ...
        System.out.println("Selecciona l'opció [1-4]: ");
        ...
        //PAS III
            case 3:
                System.out.println("Has triat multiplicar...");
                resultat = primerValor * segonValor;
                break;
        //PAS IV
            case 4:
                System.out.println("Has triat dividir...");
                resultat = primerValor / segonValor;
                break;
        //PAS V
            default:
